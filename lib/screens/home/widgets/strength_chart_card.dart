...
class _ChartContent extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // No blur — fl_chart repaints on touch, compositing a BackdropFilter under
    // an animating canvas causes dropped frames. Higher tint compensates.
    return LiquidGlassContainer(
      borderRadius: 28,
      enableBlur: false,
      tintColor: const Color(0x26FFFFFF), // 15% white — stronger tint
      child: Column(
                  ...
                  Row(
                    ...
                    children: [
                      Icon(
                        ...
                        size: 16,
                        color:
                            gained >= 0 ? Colors.green : Colors.orange,
                      ),
